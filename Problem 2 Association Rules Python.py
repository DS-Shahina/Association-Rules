...
with open("D:/C DRIVE-SSD DATA backup 15-12-2020/Desktop/360DigiTmg Assignment/Association Rules/groceries.csv") as f:
    groceries = f.read()
...
X = groceries_series['transactions'].str.join(sep = '*').str.get_dummies(sep = '*') # only take unique category
...
# # We generate top 10 Association Rules of groceries which is more purchased, because of this combinations we as a Data Scientist help The Departmental Store find the pattern of the products which is more sale either individually or together using Association Rules. 

top10rules.to_csv("groceriestop10Rules.csv", encoding = "utf-8")
